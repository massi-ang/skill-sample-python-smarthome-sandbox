    ...
    def test_discovery_directory(self):
        ...
        request = {
            "directive": {
                ...
                "payload": {"scope": {"type": "BearerToken", "token": "atoken"}},
            }
        }
        r = ApiHandlerDirective().process(
            request={"body": json.dumps(request)},
    ...
    capabilities = [
        {
            ...
            "capabilityResources": {
                "friendlyNames": [
                    ...
                    {
                        "@type": "text",
                        "value": {"text": "Velocidad", "locale": "es-MX"},
                    },
                    {"@type": "text", "value": {"text": "Vitesse", "locale": "fr-CA"}},
                ]
            },
            "configuration": {
                "supportedRange": {
                ...
                "presets": [
                    {
                        ...
                        "presetResources": {
                            "friendlyNames": [
                                ...
                                {
                                    "@type": "text",
                                    "value": {"text": "Highest", "locale": "en-US"},
                                },
                                {
                                    "@type": "text",
                                    "value": {"text": "Fast", "locale": "en-US"},
                                },
                                {
                                    "@type": "text",
                                    "value": {"text": "Alta", "locale": "es-MX"},
                                },
                                {
                                    "@type": "text",
                                    "value": {"text": "Élevée", "locale": "fr-CA"},
                                },
                            ]
                        },
                    },
                    {
                        ...
                        "presetResources": {
                            "friendlyNames": [
                                ...
                                {
                                    "@type": "text",
                                    "value": {"text": "Lowest", "locale": "en-US"},
                                },
                                {
                                    "@type": "text",
                                    "value": {"text": "Slow", "locale": "en-US"},
                                },
                                {
                                    "@type": "text",
                                    "value": {"text": "Baja", "locale": "es-MX"},
                                },
                                {
                                    "@type": "text",
                                    "value": {"text": "Faible", "locale": "fr-CA"},
                                },
                            ]
                        },
                    },
    ...
    def test__value(self):
        ...
        request = {
            "directive": {
                ...
                "payload": {"rangeValueDelta": -3, "rangeValueDeltaDefault": False},
            }
        }
        r = ApiHandlerDirective().process(
            request={"body": json.dumps(request)},
