...
def handler(event, context):
    ...
    if event["RequestType"] == "Create":
        ...
        alexa_skill_lambda_permission_statement_id = event["ResourceProperties"][
            "AlexaSkillLambdaPermissionStatementId"
        ]
        print(
            "LOG setup.index.handler.alexa_skill_lambda_permission_statement_id:",
            alexa_skill_lambda_permission_statement_id,
        )
    ...
    try:
        ...
        print(
            "Response Status Code: {0} Message: {1}".format(
